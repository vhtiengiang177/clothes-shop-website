    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Product_Sizes", x => new { x.IdProduct, x.IdSize, x.IdColor });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Product_Sizes",
                columns: new[] { "IdColor", "IdProduct", "IdSize", "ColorId", "Quantity", "State", "Stock", "UnitPrice" },
                values: new object[,]
                {
                    { 1, 11, 1, null, 0, 1, 100, 4000 },
                    { 1, 10, 1, null, 0, 1, 100, 4000 },
                    { 1, 8, 1, null, 0, 1, 100, 4000 },
                    { 1, 7, 1, null, 0, 1, 100, 4000 },
                    { 1, 6, 1, null, 0, 1, 100, 4000 },
                    { 1, 9, 1, null, 0, 1, 100, 4000 },
                    { 3, 5, 2, null, 0, 1, 100, 4000 },
                    { 1, 1, 2, null, 0, 1, 100, 2000 },
                    { 1, 1, 3, null, 0, 1, 100, 3000 },
                    { 4, 5, 2, null, 0, 1, 100, 4000 },
                    { 2, 2, 2, null, 0, 1, 100, 3000 },
                    { 1, 1, 1, null, 0, 1, 100, 1000 },
                    { 4, 3, 1, null, 0, 1, 100, 4000 },
                    { 2, 4, 1, null, 0, 1, 100, 4000 },
                    { 3, 4, 1, null, 0, 1, 100, 4000 },
                    { 3, 2, 2, null, 0, 1, 100, 3000 }
                });
            ...
            migrationBuilder.InsertData(
                table: "OrderDetails",
                columns: new[] { "IdColor", "IdOrder", "IdProduct", "IdSize", "ColorId", "Material", "ProductId", "Quantity", "SizeId", "UnitPrice" },
                values: new object[,]
                {
                    { 1, 1, 1, 1, null, null, null, 10, null, 320000.0 },
                    { 2, 1, 2, 2, null, null, null, 10, null, 280000.0 },
                    { 4, 2, 3, 1, null, null, null, 15, null, 250000.0 },
                    { 2, 2, 4, 1, null, null, null, 15, null, 320000.0 },
                    { 3, 3, 5, 2, null, null, null, 10, null, 220000.0 },
                    { 1, 3, 6, 1, null, null, null, 10, null, 195000.0 },
                    { 1, 4, 7, 1, null, null, null, 15, null, 320000.0 },
                    { 1, 4, 8, 1, null, null, null, 15, null, 320000.0 },
                    { 1, 5, 3, 1, null, null, null, 15, null, 250000.0 },
                    { 1, 5, 4, 1, null, null, null, 15, null, 320000.0 }
                });
