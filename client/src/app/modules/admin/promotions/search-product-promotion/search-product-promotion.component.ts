...
@Component({
  selector: 'app-search-product-promotion',
  templateUrl: './search-product-promotion.component.html',
  styleUrls: ['./search-product-promotion.component.css']
})

export class SearchProductPromotionComponent implements OnInit {
  ...
  categories: Category[] = [];
  actions: string[] = ['All', 'Applied', 'Not Apply'];
  minPrice: number
  maxPrice: number
